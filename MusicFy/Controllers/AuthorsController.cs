...
namespace MusicFy.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(MusicFyDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FName,LName,Username,Followers,MonthlyListeners")] Author author)
        {
            if (id != author.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MusicFyDbContext.Authors'  is null.");
            }
            var author = await _context.Authors.FindAsync(id);
            if (author != null)
            {
